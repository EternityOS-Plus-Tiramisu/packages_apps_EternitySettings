...
import com.eternity.settings.fragments.About;
import com.eternity.settings.fragments.LockScreen;
import com.eternity.settings.fragments.QuickSettings;
import com.eternity.settings.fragments.StatusBar;
/*
import com.eternity.settings.fragments.Buttons;
import com.eternity.settings.fragments.Miscellaneous;
import com.eternity.settings.fragments.Navigation;
import com.eternity.settings.fragments.Notifications;
import com.eternity.settings.fragments.Sound;
import com.eternity.settings.fragments.UserInterface;
*/

public class EternitySettingsLayout extends SettingsPreferenceFragment {

    private static final String TAG = "EternitySettingsLayout";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.eternity_settings_title);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContainer = container;
        View view = inflater.inflate(R.layout.eternity_settings, container, false);
...
*/
            ...
            getString(R.string.about_eternity)
        };
        return titleString;
    }
