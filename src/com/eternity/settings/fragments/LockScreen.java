...
import com.android.internal.util.eternity.Utils;
...
import com.eternity.settings.fragments.lockscreen.UdfpsSettings;
...
public class LockScreen extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mFingerprintManager == null || !mFingerprintManager.isHardwareDetected()) {
            ...
            if (!Utils.isPackageInstalled(getContext(), "com.eternity.udfps.icons")) {
                interfaceCategory.removePreference(mUdfpsSettings);
            }
        }
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.eternity_settings_lockscreen) {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (mFingerprintManager == null || !mFingerprintManager.isHardwareDetected()) {
                        ...
                        if (!Utils.isPackageInstalled(context, "com.eternity.udfps.icons")) {
                            keys.add(KEY_UDFPS_SETTINGS);
                        } else {
                            keys.add(KEY_FP_SUCCESS_VIBRATE);
                            keys.add(KEY_FP_ERROR_VIBRATE);
